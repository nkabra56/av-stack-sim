...
interval. Used to validate `core/control/acc.py`'s controllers against real car-following
behavior — see DESIGN.md's ACC section and `core/validation/acc_validation.py`.
